...
By default, dzcoind will dump mempool on shutdown and
...
class MempoolPersistTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(0)
        self.start_node(1)
        # Give dzcoind a second to reload the mempool
        time.sleep(1)
        ...
        self.log.debug("Prevent dzcoind from writing mempool.dat to disk. Verify that `savemempool` fails")
