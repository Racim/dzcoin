...
QT_TRANSLATE_NOOP("dzcoin-core", "Dzcoin Core"),
QT_TRANSLATE_NOOP("dzcoin-core", "The %s developers"),
...
QT_TRANSLATE_NOOP("dzcoin-core", "%d of last 100 blocks have unexpected version"),
QT_TRANSLATE_NOOP("dzcoin-core", "%s corrupt, salvage failed"),
QT_TRANSLATE_NOOP("dzcoin-core", "%s is set very high!"),
QT_TRANSLATE_NOOP("dzcoin-core", "(default: %s)"),
QT_TRANSLATE_NOOP("dzcoin-core", "(default: %u)"),
QT_TRANSLATE_NOOP("dzcoin-core", "(press q to shutdown and continue later)"),
QT_TRANSLATE_NOOP("dzcoin-core", "-maxmempool must be at least %d MB"),
...
QT_TRANSLATE_NOOP("dzcoin-core", "Append comment to the user agent string"),
QT_TRANSLATE_NOOP("dzcoin-core", "Attempt to recover private keys from a corrupt wallet on startup"),
QT_TRANSLATE_NOOP("dzcoin-core", "Automatically create Tor hidden service (default: %d)"),
QT_TRANSLATE_NOOP("dzcoin-core", "Block creation options:"),
QT_TRANSLATE_NOOP("dzcoin-core", "Cannot downgrade wallet"),
QT_TRANSLATE_NOOP("dzcoin-core", "Cannot resolve -%s address: '%s'"),
QT_TRANSLATE_NOOP("dzcoin-core", "Cannot write default address"),
QT_TRANSLATE_NOOP("dzcoin-core", "Chain selection options:"),
QT_TRANSLATE_NOOP("dzcoin-core", "Change index out of range"),
...
QT_TRANSLATE_NOOP("dzcoin-core", "Copyright (C) %i-%i"),
...
QT_TRANSLATE_NOOP("dzcoin-core", "Enable publish hash block in <address>"),
QT_TRANSLATE_NOOP("dzcoin-core", "Enable publish hash transaction in <address>"),
QT_TRANSLATE_NOOP("dzcoin-core", "Enable publish raw block in <address>"),
QT_TRANSLATE_NOOP("dzcoin-core", "Enable publish raw transaction in <address>"),
QT_TRANSLATE_NOOP("dzcoin-core", "Enable transaction replacement in the memory pool (default: %u)"),
...
QT_TRANSLATE_NOOP("dzcoin-core", "Error loading %s"),
QT_TRANSLATE_NOOP("dzcoin-core", "Error loading %s: Wallet corrupted"),
QT_TRANSLATE_NOOP("dzcoin-core", "Error loading %s: Wallet requires newer version of %s"),
QT_TRANSLATE_NOOP("dzcoin-core", "Error loading %s: You can't disable HD on an already existing HD wallet"),
QT_TRANSLATE_NOOP("dzcoin-core", "Error loading block database"),
QT_TRANSLATE_NOOP("dzcoin-core", "Error loading wallet %s. -wallet filename must be a regular file."),
QT_TRANSLATE_NOOP("dzcoin-core", "Error loading wallet %s. Duplicate -wallet filename specified."),
QT_TRANSLATE_NOOP("dzcoin-core", "Error loading wallet %s. Invalid characters in -wallet filename."),
...
QT_TRANSLATE_NOOP("dzcoin-core", "Error upgrading chainstate database"),
QT_TRANSLATE_NOOP("dzcoin-core", "Error"),
QT_TRANSLATE_NOOP("dzcoin-core", "Error: A fatal internal error occurred, see debug.log for details"),
...
QT_TRANSLATE_NOOP("dzcoin-core", "Fee (in %s/kB) to add to transactions you send (default: %s)"),
QT_TRANSLATE_NOOP("dzcoin-core", "How many blocks to check at startup (default: %u, 0 = all)"),
QT_TRANSLATE_NOOP("dzcoin-core", "Importing..."),
QT_TRANSLATE_NOOP("dzcoin-core", "Imports blocks from external blk000??.dat file on startup"),
...
QT_TRANSLATE_NOOP("dzcoin-core", "Initialization sanity check failed. %s is shutting down."),
QT_TRANSLATE_NOOP("dzcoin-core", "Insufficient funds"),
QT_TRANSLATE_NOOP("dzcoin-core", "Invalid -onion address or hostname: '%s'"),
QT_TRANSLATE_NOOP("dzcoin-core", "Invalid -proxy address or hostname: '%s'"),
QT_TRANSLATE_NOOP("dzcoin-core", "Invalid amount for -%s=<amount>: '%s'"),
QT_TRANSLATE_NOOP("dzcoin-core", "Invalid amount for -discardfee=<amount>: '%s'"),
QT_TRANSLATE_NOOP("dzcoin-core", "Invalid amount for -fallbackfee=<amount>: '%s'"),
...
QT_TRANSLATE_NOOP("dzcoin-core", "Keep the transaction memory pool below <n> megabytes (default: %u)"),
QT_TRANSLATE_NOOP("dzcoin-core", "Keypool ran out, please call keypoolrefill first"),
...
QT_TRANSLATE_NOOP("dzcoin-core", "Loading P2P addresses..."),
QT_TRANSLATE_NOOP("dzcoin-core", "Loading banlist..."),
QT_TRANSLATE_NOOP("dzcoin-core", "Loading block index..."),
QT_TRANSLATE_NOOP("dzcoin-core", "Loading wallet..."),
QT_TRANSLATE_NOOP("dzcoin-core", "Location of the auth cookie (default: data dir)"),
...
QT_TRANSLATE_NOOP("dzcoin-core", "Print this help message and exit"),
QT_TRANSLATE_NOOP("dzcoin-core", "Print version and exit"),
...
QT_TRANSLATE_NOOP("dzcoin-core", "Pruning blockstore..."),
QT_TRANSLATE_NOOP("dzcoin-core", "RPC server options:"),
QT_TRANSLATE_NOOP("dzcoin-core", "Rebuild chain state and block index from the blk*.dat files on disk"),
QT_TRANSLATE_NOOP("dzcoin-core", "Rebuild chain state from the currently indexed blocks"),
QT_TRANSLATE_NOOP("dzcoin-core", "Reducing -maxconnections from %d to %d, because of system limitations."),
...
QT_TRANSLATE_NOOP("dzcoin-core", "Replaying blocks..."),
QT_TRANSLATE_NOOP("dzcoin-core", "Rescan the block chain for missing wallet transactions on startup"),
QT_TRANSLATE_NOOP("dzcoin-core", "Rescanning..."),
QT_TRANSLATE_NOOP("dzcoin-core", "Rewinding blocks..."),
...
QT_TRANSLATE_NOOP("dzcoin-core", "Send transactions with full-RBF opt-in enabled (default: %u)"),
...
QT_TRANSLATE_NOOP("dzcoin-core", "Set maximum BIP141 block weight (default: %d)"),
...
QT_TRANSLATE_NOOP("dzcoin-core", "Starting network threads..."),
QT_TRANSLATE_NOOP("dzcoin-core", "The source code is available from %s."),
QT_TRANSLATE_NOOP("dzcoin-core", "The transaction amount is too small to pay the fee"),
QT_TRANSLATE_NOOP("dzcoin-core", "The wallet will avoid paying less than the minimum relay fee."),
QT_TRANSLATE_NOOP("dzcoin-core", "This is experimental software."),
QT_TRANSLATE_NOOP("dzcoin-core", "This is the minimum transaction fee you pay on every transaction."),
QT_TRANSLATE_NOOP("dzcoin-core", "This is the transaction fee you will pay if you send a transaction."),
QT_TRANSLATE_NOOP("dzcoin-core", "Threshold for disconnecting misbehaving peers (default: %u)"),
QT_TRANSLATE_NOOP("dzcoin-core", "Tor control port password (default: empty)"),
QT_TRANSLATE_NOOP("dzcoin-core", "Tor control port to use if onion listening enabled (default: %s)"),
QT_TRANSLATE_NOOP("dzcoin-core", "Transaction amount too small"),
QT_TRANSLATE_NOOP("dzcoin-core", "Transaction amounts must not be negative"),
QT_TRANSLATE_NOOP("dzcoin-core", "Transaction fee and change calculation failed"),
QT_TRANSLATE_NOOP("dzcoin-core", "Transaction has too long of a mempool chain"),
QT_TRANSLATE_NOOP("dzcoin-core", "Transaction must have at least one recipient"),
...
QT_TRANSLATE_NOOP("dzcoin-core", "Unable to bind to %s on this computer. %s is probably already running."),
QT_TRANSLATE_NOOP("dzcoin-core", "Unable to start HTTP server. See debug log for details."),
QT_TRANSLATE_NOOP("dzcoin-core", "Unknown network specified in -onlynet: '%s'"),
QT_TRANSLATE_NOOP("dzcoin-core", "Unsupported argument -benchmark ignored, use -debug=bench."),
QT_TRANSLATE_NOOP("dzcoin-core", "Unsupported argument -debugnet ignored, use -debug=net."),
QT_TRANSLATE_NOOP("dzcoin-core", "Unsupported argument -tor found, use -onion."),
QT_TRANSLATE_NOOP("dzcoin-core", "Unsupported logging category %s=%s."),
QT_TRANSLATE_NOOP("dzcoin-core", "Upgrade wallet to latest format on startup"),
QT_TRANSLATE_NOOP("dzcoin-core", "Upgrading UTXO database"),
QT_TRANSLATE_NOOP("dzcoin-core", "Use UPnP to map the listening port (default: %u)"),
QT_TRANSLATE_NOOP("dzcoin-core", "Use the test chain"),
QT_TRANSLATE_NOOP("dzcoin-core", "User Agent comment (%s) contains unsafe characters."),
QT_TRANSLATE_NOOP("dzcoin-core", "Username for JSON-RPC connections"),
QT_TRANSLATE_NOOP("dzcoin-core", "Verifying blocks..."),
QT_TRANSLATE_NOOP("dzcoin-core", "Verifying wallet(s)..."),
QT_TRANSLATE_NOOP("dzcoin-core", "Wallet %s resides outside data directory %s"),
QT_TRANSLATE_NOOP("dzcoin-core", "Wallet debugging/testing options:"),
QT_TRANSLATE_NOOP("dzcoin-core", "Wallet needed to be rewritten: restart %s to complete"),
QT_TRANSLATE_NOOP("dzcoin-core", "Wallet options:"),
QT_TRANSLATE_NOOP("dzcoin-core", "Warning"),
QT_TRANSLATE_NOOP("dzcoin-core", "Warning: unknown new rules activated (versionbit %i)"),
QT_TRANSLATE_NOOP("dzcoin-core", "Whether to operate in a blocks only mode (default: %u)"),
QT_TRANSLATE_NOOP("dzcoin-core", "Zapping all transactions from wallet..."),
QT_TRANSLATE_NOOP("dzcoin-core", "ZeroMQ notification options:"),
};
