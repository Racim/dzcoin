...
#include "qt/dzcoinamountfield.h"
...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<DzcoinAmountField*>("payAmount")->setValue(amount);
...
//
//     src/qt/test/test_dzcoin-qt -platform xcb      # Linux
//     src/qt/test/test_dzcoin-qt -platform windows  # Windows
//     src/qt/test/test_dzcoin-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    QString balanceComparison = DzcoinUnits::formatWithUnit(unit, balance, false, DzcoinUnits::separatorAlways);
    ...
    // Amount input
    DzcoinAmountField* amountInput = receiveCoinsDialog.findChild<DzcoinAmountField*>("reqAmount");
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: dzcoin:")) != -1);
