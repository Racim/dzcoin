// Copyright (c) 2015-2016 The Dzcoin Core developers
...
{
    RenameThread("dzcoin-httpworker");
    queue->Run();
}
...
void StopHTTPServer()
{
    ...
    if (eventBase) {
        ...
        // (see discussion in https://github.com/dzcoin/dzcoin/pull/6990)
