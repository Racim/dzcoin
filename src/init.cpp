 ...
 * between dzcoind, and dzcoin-qt and non-server tools.
*/
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/dzcoin/dzcoin>";
    const std::string URL_WEBSITE = "<https://dzcoincore.org>";
