Bitcoin version 0.7.0 is now available for download at:
  http://sourceforge.net/projects/dzcoin/files/Bitcoin/dzcoin-0.7.0/

We recommend that everybody running prior versions of dzcoind/Bitcoin-Qt
...
source-only tarballs/zipballs directly from there:
  https://github.com/dzcoin/dzcoin/tarball/v0.7.0  # .tar.gz
  https://github.com/dzcoin/dzcoin/zipball/v0.7.0  # .zip
...
in your terminal, then install the dzcoin-qt package:
  sudo apt-get install dzcoin-qt
...
Core dzcoin handling and blockchain database
...
* Ensure a changed dzcoin unit immediately updates all GUI elements that use units
...
* (Windows only): enable ASLR and DEP for dzcoin-qt.exe
* (Windows only): add meta-data to dzcoin-qt.exe (e.g. description)
...
* Bash programmable completion for dzcoind(1)
