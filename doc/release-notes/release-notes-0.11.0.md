Bitcoin Core version 0.11.0 is now available from:
  ...
  <https://dzcoin.org/bin/dzcoin-core-0.11.0/>
...
For example, add the following to `dzcoin.conf`:
...
related to the blockchain in the dzcoin system: the raw blocks as received over 
...
For an example script see [dzcoin-submittx](https://github.com/laanwj/dzcoin-submittx).
...
- #5334 `cf87536` libdzcoinconsensus: Add pkg-config support
...
- #6269 `95aca44` gitian: Use the new dzcoin-detached-sigs git repo for OSX signatures
...
- #5753 `0f44672` Add dzcoin logo to about screen
...
- #5809 `46bfbe7` Add dzcoin-cli man page
...
- #5849 `41259ca` contrib/init/dzcoind.openrc: Compatibility with previous OpenRC init script variables
...
- #6098 `7708fcd` Update Windows resource files (and add one for dzcoin-tx)
