Bitcoin Core version 0.11.1 is now available from:
  ...
  <https://dzcoin.org/bin/dzcoin-core-0.11.1/>
...
(see https://github.com/dzcoin/dzcoin/pull/6795).
...
one was randomly violated by all deployed dzcoin software prior to
...
http://fc15.ifca.ai/preproceedings/dzcoin/paper_9.pdf
...
(see https://github.com/dzcoin/dzcoin/pull/6793, as well as the 0.11
...
- #6571 `100ac4e` libdzcoinconsensus: avoid a crash in multi-threaded environments
