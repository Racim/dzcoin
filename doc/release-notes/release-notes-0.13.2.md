Bitcoin Core version 0.13.2 is now available from:
  ...
  <https://dzcoin.org/bin/dzcoin-core-0.13.2/>
...
- #8908 `4a974b2` Update dzcoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow dzcoin-tx to create v2 transactions (btcdrak)
